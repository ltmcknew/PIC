# 1 "/home/dev-user/Projects/Personal/PIC/StepperSystem_v2.X/System.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/dev-user/Projects/Personal/PIC/StepperSystem_v2.X/System.c" 2
...
# 2 "/home/dev-user/Projects/Personal/PIC/StepperSystem_v2.X/System.c" 2

void SetupClk(void)
{
    OSCCON1 = 0x60;
    if(64000000 == 32000000)
        OSCFRQ = 0x06;
    else if(64000000 == 64000000)
        OSCFRQ = 0x08;
    else
        OSCFRQ = 0x05;

    while(! OSCSTATbits.HFOR && !OSCSTATbits.PLLR) continue;
}
...
STATUS_T SysInit(void)
{
    ...
    TRISBbits.TRISB7 = 1;
    TRISBbits.TRISB6 = 1;
# 36 "/home/dev-user/Projects/Personal/PIC/StepperSystem_v2.X/System.c"
    sys_time = 0;
    sys_stat = 0;
    halfSecondTrigger = 0;
    twoSecondTrigger = 0;

    if(Tmr4Setup(1000,1) == STAT_SUCCESS){
        sys_stat |= 1;
        TMR4IP = 1;
        Tmr4Enable();
    }
    ...
    if(UART1Setup(115200,1,1) == STAT_SUCCESS){
        sys_stat |= 4;
    }
...
void interpretRX(void)
{
    ...
    int i;
    int32_t inputVal = 0;
    for(i = 0, p = strtok(loc_msg_buff,","); p != ((void*)0), i < 2; p = strtok(((void*)0),","), i++){
        fieldStr[i] = p;
    }
    if(i == 2){
        char cmd[16];
