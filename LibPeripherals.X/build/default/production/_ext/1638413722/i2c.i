# 1 "/home/dev-user/Projects/Personal/PIC/LibPeripherals.X/i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/dev-user/Projects/Personal/PIC/LibPeripherals.X/i2c.c" 2
# 1 "/home/dev-user/Projects/Personal/PIC/LibPeripherals.X/i2c.h" 1
# 11 "/home/dev-user/Projects/Personal/PIC/LibPeripherals.X/i2c.h"
...
# 12 "/home/dev-user/Projects/Personal/PIC/LibPeripherals.X/i2c.h" 2
# 1 "/home/dev-user/Projects/Personal/PIC/LibPeripherals.X/timers.h" 1
# 61 "/home/dev-user/Projects/Personal/PIC/LibPeripherals.X/timers.h"
...
# 13 "/home/dev-user/Projects/Personal/PIC/LibPeripherals.X/i2c.h" 2
# 45 "/home/dev-user/Projects/Personal/PIC/LibPeripherals.X/i2c.h"
...
# 2 "/home/dev-user/Projects/Personal/PIC/LibPeripherals.X/i2c.c" 2
...
STATUS_T I2C1Setup(_Bool high_speed)
{
    ...
    if(high_speed){
        if(Tmr6Setup(2000000,0) == STAT_SUCCESS){
            Tmr6Enable();
        } else return STAT_FAIL;
    } else {
        if(Tmr6Setup(500000,0) == STAT_SUCCESS){
            Tmr6Enable();
        } else return STAT_FAIL;
    }
...
uint8_t I2C1Write(uint8_t byteCnt, uint8_t devAddr)
{
    ...
    for(write_count = 0; write_count < byteCnt; write_count++){
        I2C1TXB = I2C1_buff_out[write_count];
...
uint8_t I2C1Read(uint8_t byteCnt, uint8_t devAddr)
{
    while(I2C1STAT0bits.MMA && !I2C1STAT0bits.BFRE);
