...
STATUS_T Tmr2Setup(uint32_t tmr_freq, bool use_int)
{
    Tmr2Disable();
    T2CLKCON = 0x01;    //Fosc/4 is clock source
...
STATUS_T Tmr4Setup(uint32_t tmr_freq, bool use_int)
{
    Tmr4Disable();
    T4CLKCON = 0x01;    //Fosc/4 is clock source
...
STATUS_T Tmr6Setup(uint32_t tmr_freq, bool use_int)
{
    Tmr6Disable();
    T6CLKCON = 0x01;    //Fosc/4 is clock source
