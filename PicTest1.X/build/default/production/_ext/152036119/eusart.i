# 1 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/eusart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/eusart.c" 2
# 1 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/eusart.h" 1
# 11 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/eusart.h"
...
# 12 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/eusart.h" 2
...
# 13 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/eusart.h" 2
...
# 2 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/eusart.c" 2
...
STATUS_T EUSARTSetup(uint32_t set_baud, _Bool use_tx, _Bool use_rx)
{
    ...
    RC1STAbits.CREN = 0;
    TX1STAbits.TXEN = 0;
# 30 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/eusart.c"
    uint32_t regVal = 32000000/4;
    ...
    if(use_tx){
        ...
        eusart_tx_sys_active = 1;
    } else {
        eusart_tx_sys_active = 0;
    }
    ...
    if(use_rx){
        ...
        eusart_rx_sys_active = 1;
        RCIF = 0;
        RCIE = 1;
    } else {
        RC1STA = 0b00000000;
        eusart_rx_sys_active = 0;
    }
...
STATUS_T load_tx_msg_str(char * in_bytes)
{
    ...
    if((eusart_tx_buff_tail != eusart_tx_buff_head) || !eusart_tx_buff_full){
        if(((eusart_tx_buff_tail - eusart_tx_buff_head) >= strlen(in_bytes)) || ((eusart_tx_buff_head == eusart_tx_buff_tail) && !eusart_tx_buff_full)){
            for(uint8_t i = 0; i < strlen(in_bytes); i++){
                eusart_tx_buff[eusart_tx_buff_head++] = in_bytes[i];
            }
            if(eusart_tx_buff_head == eusart_tx_buff_tail){
                eusart_tx_buff_full = 1;
            }
        } else {
            return STAT_FAIL;
        }
