# 1 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/System.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/System.c" 2
...
TIMEREVEN_T tmr4;
# 2 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/System.c" 2
...
STATUS_T SysInit(void)
{
    ...
    setup_dht11_snsr();
    setup_irdist_snsr(1);
# 65 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/System.c"
    tmr4.CON = &T4CON;
    tmr4.CLKCON = &T4CLKCON;
    tmr4.HLT = &T4HLT;
    tmr4.PREG = &T4PR;
    tmr4.intBitPos = 0x08;
    if(TmrSetup(tmr4,1000,1) == STAT_SUCCESS){
        sys_stat |= 1;
        TmrEnable(tmr4);
    }
# 83 "/home/dev-user/Projects/Personal/PIC/PicTest1.X/System.c"
    if(EUSARTSetup(115200,1,1) == STAT_SUCCESS){
        sys_stat |= 16;
    }
