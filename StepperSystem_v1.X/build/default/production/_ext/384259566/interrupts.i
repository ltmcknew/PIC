# 1 "/home/dev-user/Projects/Personal/PIC/StepperSystem_v1.X/interrupts.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/dev-user/Projects/Personal/PIC/StepperSystem_v1.X/interrupts.c" 2
...
# 2 "/home/dev-user/Projects/Personal/PIC/StepperSystem_v1.X/interrupts.c" 2


void __attribute__((picinterrupt(("")))) Isr(void){
# 13 "/home/dev-user/Projects/Personal/PIC/StepperSystem_v1.X/interrupts.c"
    if(TMR1IF){
        TMR1IF = 0;
        allowStep0 = 1;
        if(pendingSteps0 == 0){
